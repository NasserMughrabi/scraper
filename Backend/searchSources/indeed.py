...
allowKeywords = ["software", "developer", "web"
            "frontend", "front-end", "front end",
            "fullstack", "full-stack", "full stack",
            "backend", "back-end", "back end"]

blockKeywords = ["senior", "manager", "lead"]
...
def search_utah_indeed(driver):
    utah_jobs_url = "https://www.indeed.com/jobs?q=software+developer&l=Utah&sc=0kf%3Aexplvl%28ENTRY_LEVEL%29%3B&radius=50&explvl=entry_level&fromage=7&vjk=273b8a199f978c41"
    utah_jobs = search_url_indeed(utah_jobs_url, driver)
    return utah_jobs
...
def search_url_indeed(indeedURL, driver):
    jobs_found = []
